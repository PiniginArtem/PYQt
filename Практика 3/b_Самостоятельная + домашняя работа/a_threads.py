...
class SystemInfo(QtCore.QThread):
    ...
    def run(self) -> None:  # TODO переопределить метод run
        if self.__delay is None:  # TODO Если задержка не передана в поток перед его запуском
            self.__delay = 1  # TODO то устанавливайте значение 1
        ...
        while True:  # TODO Запустите бесконечный цикл получения информации о системе
            ...
            time.sleep(self.__delay)  # TODO с помощью функции .sleep() приостановите выполнение цикла на время self.delay
